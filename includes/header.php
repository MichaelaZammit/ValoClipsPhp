...
<div class="container">
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link <?php if ($CURRENT_PAGE == "Challenges") { echo "active-button"; }?>" href="challenges.php"><input type="image" id="image" alt="Challenges" src="images/challenges.png" width="auto" height="35"></a></li>
